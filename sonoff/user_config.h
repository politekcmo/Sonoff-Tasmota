...
#define STA_SSID1              "SECRET"      // [Ssid1] Wifi SSID
#define STA_PASS1              "SECRET"  // [Password1] Wifi password
#define STA_SSID2              "test"      // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              "testing"  // [Password2] Optional alternate AP Wifi password
...
#else
  #define MQTT_HOST            "castle"          // [MqttHost]
  #define MQTT_PORT            1883              // [MqttPort] MQTT port (10123 on CloudMQTT)
  #define MQTT_USER            "secret"       // [MqttUser] Optional user
  #define MQTT_PASS            "secret"       // [MqttPassword] Optional password
#endif
